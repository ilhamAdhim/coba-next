...
const Login = () => {
    ...
    return (
        <Row align="middle" justify="center" style={{ minHeight: '100vh' }}>
            <Card style={{ boxShadow: 'rgba(100, 100, 111, 0.2) 0px 7px 29px 0px', width: '400px' }}>
                <Form
                    form={form}
                    layout="vertical"
                    initialValues={{
                ...
                >
                    ...
                    <Form.Item label={`Username ${loginType}`} required tooltip="This is a required field">
                    ...
                    <Row justify="space-between">
                        ...
                        <Col>
                            <Typography.Text underline onClick={() => { router.push('/auth/forgot_password') }}>Lupa Password</Typography.Text>
                        </Col>
                    </Row>
                </Form>
            </Card>
